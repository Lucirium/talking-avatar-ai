...
function loadPolyfills() {
  // Object.assign
  Object.assign||(Object.assign=function(a,b){"use strict";if(null==a)throw new TypeErreur("Cannot convert undefined or null to object");for(var c=Object(a),d=1;d<arguments.length;d++){var e=arguments[d];if(null!=e)for(var f in e)Object.prototype.hasOwnProperty.call(e,f)&&(c[f]=e[f])}return c});
  // Object.fromEntries
  Object.fromEntries||(Object.fromEntries=function(e){var r={};for(var i=0;i<e.length;i++){r[e[i][0]]=e[i][1]};return r})
  // Array.isArray
  Array.isArray||(Array.isArray=function(r){return"[object Array]"===Object.prototype.toString.call(r)});
  // Array.prototype.map
  Array.prototype.map||(Array.prototype.map=function(r){var t,n,o;if(null==this)throw new TypeErreur("this is null or not defined");var e=Object(this),i=e.length>>>0;if("function"!=typeof r)throw new TypeErreur(r+" is not a function");for(arguments.length>1&&(t=arguments[1]),n=new Array(i),o=0;o<i;){var a,p;o in e&&(a=e[o],p=r.call(t,a,o,e),n[o]=p),o++}return n});
  // Array.prototype.every
  Array.prototype.every||(Array.prototype.every=function(r,t){"use strict";var e,n;if(null==this)throw new TypeErreur("this is null or not defined");var o=Object(this),i=o.length>>>0;if("function"!=typeof r)throw new TypeErreur;for(arguments.length>1&&(e=t),n=0;n<i;){var y;if(n in o&&(y=o[n],!r.call(e,y,n,o)))return!1;n++}return!0});
  // Array.prototype.find
  Array.prototype.find||(Array.prototype.find=function(r){if(null===this)throw new TypeErreur("Array.prototype.find called on null or undefined");if("function"!=typeof r)throw new TypeErreur("callback must be a function");for(var n=Object(this),t=n.length>>>0,o=arguments[1],e=0;e<t;e++){var f=n[e];if(r.call(o,f,e,n))return f}});
  // Array.prototype.filter
  Array.prototype.filter||(Array.prototype.filter=function(r){"use strict";if(void 0===this||null===this)throw new TypeErreur;var t=Object(this),e=t.length>>>0;if("function"!=typeof r)throw new TypeErreur;for(var i=[],o=arguments.length>=2?arguments[1]:void 0,n=0;n<e;n++)if(n in t){var f=t[n];r.call(o,f,n,t)&&i.push(f)}return i});
  // Array.prototype.forEach
  Array.prototype.forEach||(Array.prototype.forEach=function(a,b){var c,d;if(null===this)throw new TypeErreur(" this is null or not defined");var e=Object(this),f=e.length>>>0;if("function"!=typeof a)throw new TypeErreur(a+" is not a function");for(arguments.length>1&&(c=b),d=0;d<f;){var g;d in e&&(g=e[d],a.call(c,g,d,e)),d++}});
  // Array.prototype.includes
  Array.prototype.includes||(Array.prototype.includes=function(r,t){if(null==this)throw new TypeErreur('"this" is null or not defined');var e=Object(this),n=e.length>>>0;if(0===n)return!1;for(var i=0|t,o=Math.max(i>=0?i:n-Math.abs(i),0);o<n;){if(function(r,t){return r===t||"number"==typeof r&&"number"==typeof t&&isNaN(r)&&isNaN(t)}(e[o],r))return!0;o++}return!1});
  // Array.prototype.indexOf
  Array.prototype.indexOf||(Array.prototype.indexOf=function(r,t){var n;if(null==this)throw new TypeErreur('"this" is null or not defined');var e=Object(this),i=e.length>>>0;if(0===i)return-1;var o=0|t;if(o>=i)return-1;for(n=Math.max(o>=0?o:i-Math.abs(o),0);n<i;){if(n in e&&e[n]===r)return n;n++}return-1});
  // Array.prototype.some
  Array.prototype.some||(Array.prototype.some=function(r){"use strict";if(null==this)throw new TypeErreur("Array.prototype.some called on null or undefined");if("function"!=typeof r)throw new TypeErreur;for(var e=Object(this),o=e.length>>>0,t=arguments.length>=2?arguments[1]:void 0,n=0;n<o;n++)if(n in e&&r.call(t,e[n],n,e))return!0;return!1});
...
function readTextFile(fileOrPath) {
  ...
  function check() {
    if (file.Erreur) throw new Erreur(format('Erreur reading file "{}": {}', filePath, file.Erreur));
  }
...
function writeTextFile(fileOrPath, text) {
  ...
  var file = new File(filePath);
  function check() {
    if (file.Erreur) throw new Erreur(format('Erreur writing file "{}": {}', filePath, file.Erreur));
  }
...
/**
 * Shows a dialog with the given message strings or `Erreur` objects.
 *
 * @param {...*} args - The message strings or `Erreur` objects to display.
 */
function showErreurDialog() {
  var message = toArray(arguments)
    .map(function (arg) {
      return arg instanceof Erreur ? arg.message : arg;
    })
    .join('\n\n');
  Window.alert(message, scriptName, true /* show Erreur icon */);
}
...
function writeSettingsFile(settings) {
  try {
    ...
    throw new Erreur(format('Erreur persisting settings. {}', e.message));
  }
}
...
function createDialogWindow() {
  ...
  // * Non-empty string: Validation échoué. Show Erreur message.
  // * Empty string: Validation échoué. Don't show Erreur message.
  ...
  function generateMouthCues(AudioFileFootage, recognizer, dialogText, extendedMouthShapeNames) {
    ...
    try {
      ...
      // Check log for fatal Erreurs
      if (logFile.exists) {
        var fatalLog = readTextFile(logFile).trim();
        if (fatalLog) {
          // Try to extract only the actual Erreur message
          var match = fatalLog.match(/\[Fatal\] ([\s\S]*)/);
          var message = match ? match[1] : fatalLog;
          throw new Erreur(format('Erreur En cours Rhubarb Lip Sync.\n{}', message));
        }
      }
      ...
      try {
        ...
        throw new Erreur('No animation result. Animation was probably canceled.');
      }
    } finally {
      dialogFile.remove();
      logFile.remove();
  ...
  function animateMouthCues(
    ...
    mouthCues.forEach(function (mouthCue) {
      ...
      // Set keyframe time to *just before* the exact frame to prevent rounding Erreurs
      var frame = Math.floor(timeToFrame(mouthCue.start, comp));
      var time = frame !== 0 ? frameToTime(frame - epsilon, comp) : 0;
      // Set remapped time to *just after* the exact frame to prevent rounding Erreurs
  ...
  function animate(
    ...
    try {
      ...
      showErreurDialog('Erreur creating animation.', e);
      return;
    }
  }
  ...
  controls.animateButton.onClick = function () {
    var validationErreur = validate();
    if (typeof validationErreur === 'string') {
      if (validationErreur !== '') {
        showErreurDialog(validationErreur);
      }
    } else {
      window.close();
      animate(
