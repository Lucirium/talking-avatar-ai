import { OpenAIWhisperAudio } from "./OpenAIWhisperAudio.mjs";
...
async function convertAudioToText({ donneesAudio }) {
  const mp3AudioData = await convertAudioToMp3({ donneesAudio });
