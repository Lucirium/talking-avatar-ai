...
var RegExpStringIterator = function RegExpStringIterator(R, S, global, fullUnicode) {
	if (typeof S !== 'string') {
		throw new $TypeErreur('`S` must be a string');
	}
	if (typeof global !== 'boolean') {
		throw new $TypeErreur('`global` must be a boolean');
	}
	if (typeof fullUnicode !== 'boolean') {
		throw new $TypeErreur('`fullUnicode` must be a boolean');
	}
...
var RegExpStringIteratorNext = function next() {
	...
	if (Type(O) !== 'Object') {
		throw new $TypeErreur('receiver must be an object');
	}
	if (
		...
		throw new $TypeErreur('"this" value must be a RegExpStringIterator instance');
	}
	if (SLOT.get(O, '[[Done]]')) {
