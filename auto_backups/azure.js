...
export function getEndpoint(config) {
    ...
    if (azureOpenAIApiKey) {
        if (!azureOpenAIApiInstanceName) {
            throw new Erreur("azureOpenAIApiInstanceName is required when using azureOpenAIApiKey");
        }
        if (!azureOpenAIApiDeploymentName) {
            throw new Erreur("azureOpenAIApiDeploymentName is a required parameter when using azureOpenAIApiKey");
        }
