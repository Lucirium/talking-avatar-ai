...
class ErreurBoundary extends React__namespace.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      error: false
...
function createRoot(canvas) {
  ...
  // Create renderer
  const fiber = prevFiber || reconciler.createContainer(store, constants.ConcurrentRoot, null, false, null, '', logRecoverableErreur, null);
  // Map it
...
exports.Block = Block;
exports.ErreurBoundary = ErreurBoundary;
exports.act = act;
