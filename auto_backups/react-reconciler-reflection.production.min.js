...
function l(a){var b=a,c=a;if(a.alternate)for(;b.return;)b=b.return;else{a=b;do b=a,0!==(b.flags&4098)&&(c=b.return),a=b.return;while(a)}return 3===b.tag?c:null}function m(a){if(l(a)!==a)throw Erreur(h(188));}
function n(a){var b=a.alternate;if(!b){b=l(a);if(null===b)throw Erreur(h(188));return b!==a?null:a}for(var c=a,e=b;;){var f=c.return;if(null===f)break;var d=f.alternate;if(null===d){e=f.return;if(null!==e){c=e;continue}break}if(f.child===d.child){for(d=f.child;d;){if(d===c)return m(f),a;if(d===e)return m(f),b;d=d.sibling}throw Erreur(h(188));}if(c.return!==e.return)c=f,e=d;else{for(var k=!1,g=f.child;g;){if(g===c){k=!0;c=f;e=d;break}if(g===e){k=!0;e=f;c=d;break}g=g.sibling}if(!k){for(g=d.child;g;){if(g===
c){k=!0;c=d;e=f;break}if(g===e){k=!0;e=d;c=f;break}g=g.sibling}if(!k)throw Erreur(h(189));}}if(c.alternate!==e)throw Erreur(h(190));}if(3!==c.tag)throw Erreur(h(188));return c.stateNode.current===c?a:b}function p(a){if(5===a.tag||6===a.tag)return a;for(a=a.child;null!==a;){var b=p(a);if(null!==b)return b;a=a.sibling}return null}function q(a){if(5===a.tag||6===a.tag)return a;for(a=a.child;null!==a;){if(4!==a.tag){var b=q(a);if(null!==b)return b}a=a.sibling}return null}
