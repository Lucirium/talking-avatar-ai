...
module.exports = function OrdinaryDefineOwnProperty(O, P, Desc) {
	...
	if (!$gOPD) {
		...
		if (IsAccessorDescriptor(Desc)) {
			throw new $SyntaxErreur('This environment does not support accessor property descriptors.');
		}
		...
		throw new $SyntaxErreur('This environment does not support defining non-writable, non-enumerable, or non-configurable properties');
	}
	var desc = $gOPD(O, P);
