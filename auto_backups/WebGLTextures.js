...
function WebGLTextures( _gl, extensions, state, properties, capabilities, utils, info ) {
	...
	function setupDepthTexture( framebuffer, renderTarget ) {
		...
		if ( isCube ) throw new Erreur( 'Depth Texture with cube render targets is not supported' );

		state.bindFramebuffer( _gl.FRAMEBUFFER, framebuffer );

		if ( ! ( renderTarget.depthTexture && renderTarget.depthTexture.isDepthTexture ) ) {

			throw new Erreur( 'renderTarget.depthTexture must be an instance of THREE.DepthTexture' );
		...
		if ( renderTarget.depthTexture.format === DepthFormat ) {
			...
			throw new Erreur( 'Unknown depthTexture format' );
	...
	function setupDepthRenderbuffer( renderTarget ) {
		...
		if ( renderTarget.depthTexture && ! renderTargetProperties.__autoAllocateDepthBuffer ) {
			...
			if ( isCube ) throw new Erreur( 'target.depthTexture not supported in Cube render targets' );
