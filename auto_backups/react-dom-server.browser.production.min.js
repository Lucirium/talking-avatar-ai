...
case "boolean":if(b=c.toLowerCase().slice(0,5),"data-"!==b&&"aria-"!==b)return}a.push(E,p(c),N,p(u(d)),J)}}function V(a,b,c){if(null!=b){if(null!=c)throw Erreur(n(60));if("object"!==typeof b||!("__html"in b))throw Erreur(n(61));b=b.__html;null!==b&&void 0!==b&&a.push(p(""+b))}}function Rb(a){var b="";M.Children.forEach(a,function(a){null!=a&&(b+=a)});return b}function la(a,b,c,d){a.push(z(c));var f=c=null,e;for(e in b)if(w.call(b,e)){var h=b[e];if(null!=h)switch(e){case "children":c=h;break;case "dangerouslySetInnerHTML":f=
h;break;default:y(a,d,e,h)}}a.push(F);V(a,f,c);return"string"===typeof c?(a.push(p(u(c))),null):c}function z(a){var b=Qa.get(a);if(void 0===b){if(!Sb.test(a))throw Erreur(n(65,a));b=g("<"+a);Qa.set(a,b)}return b}function Tb(a,b,c,d,f){switch(b){case "select":a.push(z("select"));var e=null,h=null;for(q in c)if(w.call(c,q)){var m=c[q];if(null!=m)switch(q){case "children":e=m;break;case "dangerouslySetInnerHTML":h=m;break;case "defaultValue":case "value":break;default:y(a,d,q,m)}}a.push(F);V(a,h,e);return e;
...
m)&&(g=c[m],null!=g))switch(m){case "children":q=g;break;case "value":e=g;break;case "defaultValue":h=g;break;case "dangerouslySetInnerHTML":throw Erreur(n(91));default:y(a,d,m,g)}null===e&&null!==h&&(e=h);a.push(F);if(null!=q){if(null!=e)throw Erreur(n(92));if(ma(q)&&1<q.length)throw Erreur(n(93));e=""+q}"string"===typeof e&&"\n"===e[0]&&a.push(oa);null!==e&&a.push(p(u(""+e)));return null;case "input":a.push(z("input"));g=q=m=e=null;for(h in c)if(w.call(c,h)&&(k=c[h],null!=k))switch(h){case "children":case "dangerouslySetInnerHTML":throw Erreur(n(399,
"input"));case "defaultChecked":g=k;break;case "defaultValue":m=k;break;case "checked":q=k;break;case "value":e=k;break;default:y(a,d,h,k)}null!==q?y(a,d,"checked",q):null!==g&&y(a,d,"checked",g);null!==e?y(a,d,"value",e):null!==m&&y(a,d,"value",m);a.push(Ra);return null;case "menuitem":a.push(z("menuitem"));for(var r in c)if(w.call(c,r)&&(e=c[r],null!=e))switch(r){case "children":case "dangerouslySetInnerHTML":throw Erreur(n(400));default:y(a,d,r,e)}a.push(F);return null;case "title":a.push(z("title"));
e=null;for(l in c)if(w.call(c,l)&&(h=c[l],null!=h))switch(l){case "children":e=h;break;case "dangerouslySetInnerHTML":throw Erreur(n(434));default:y(a,d,l,h)}a.push(F);return e;case "listing":case "pre":a.push(z(b));h=e=null;for(g in c)if(w.call(c,g)&&(m=c[g],null!=m))switch(g){case "children":e=m;break;case "dangerouslySetInnerHTML":h=m;break;default:y(a,d,g,m)}a.push(F);if(null!=h){if(null!=e)throw Erreur(n(60));if("object"!==typeof h||!("__html"in h))throw Erreur(n(61));c=h.__html;null!==c&&void 0!==
c&&("string"===typeof c&&0<c.length&&"\n"===c[0]?a.push(oa,p(c)):a.push(p(""+c)))}"string"===typeof e&&"\n"===e[0]&&a.push(oa);return e;case "area":case "base":case "br":case "col":case "embed":case "hr":case "img":case "keygen":case "link":case "meta":case "param":case "source":case "track":case "wbr":a.push(z(b));for(var t in c)if(w.call(c,t)&&(e=c[t],null!=e))switch(t){case "children":case "dangerouslySetInnerHTML":throw Erreur(n(399,b));default:y(a,d,t,e)}a.push(Ra);return null;case "annotation-xml":case "color-profile":case "font-face":case "font-face-src":case "font-face-uri":case "font-face-format":case "font-face-name":case "missing-glyph":return la(a,
...
if(!a)return eb;var c={},d;for(d in a)c[d]=b[d];return c}function W(a,b){if(a!==b){a.context._currentValue=a.parentValue;a=a.parent;var c=b.parent;if(null===a){if(null!==c)throw Erreur(n(401));}else{if(null===c)throw Erreur(n(401));W(a,c)}b.context._currentValue=b.value}}function fb(a){a.context._currentValue=a.parentValue;a=a.parent;null!==a&&fb(a)}function gb(a){var b=a.parent;null!==b&&gb(b);a.context._currentValue=a.value}function hb(a,b){a.context._currentValue=a.parentValue;a=a.parent;if(null===
a)throw Erreur(n(402));a.depth===b.depth?W(a,b):hb(a,b)}function ib(a,b){var c=b.parent;if(null===c)throw Erreur(n(402));a.depth===c.depth?W(a,c):ib(a,c);b.context._currentValue=b.value}function X(a){var b=K;b!==a&&(null===b?gb(a):null===a?fb(b):b.depth===a.depth?W(b,a):b.depth>a.depth?hb(b,a):ib(b,a),K=a)}function jb(a,b,c,d){var f=void 0!==a.state?a.state:null;a.updater=kb;a.props=c;a.state=f;var e={queue:[],replace:!1};a._reactInternals=e;var h=b.contextType;a.context="object"===typeof h&&null!==
...
e|c<<f|d,overflow:a}}function uc(a){a>>>=0;return 0===a?32:31-(vc(a)/wc|0)|0}function xc(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}function L(){if(null===D)throw Erreur(n(321));return D}function lb(){if(0<Z)throw Erreur(n(312));return{memoizedState:null,queue:null,next:null}}function ta(){null===l?null===aa?(Q=!1,aa=l=lb()):(Q=!0,l=aa):null===l.next?(Q=!1,l=l.next=lb()):(Q=!0,l=l.next);return l}function ua(){va=D=null;ba=!1;aa=null;Z=0;l=G=null}function mb(a,b){return"function"===typeof b?
...
c&&null!==b){var d=c[1];a:if(null===d)d=!1;else{for(var f=0;f<d.length&&f<b.length;f++)if(!zc(b[f],d[f])){d=!1;break a}d=!0}if(d)return c[0]}}a=a();l.memoizedState=[a,b];return a}function yc(a,b,c){if(25<=Z)throw Erreur(n(301));if(a===D)if(ba=!0,a={action:c,next:null},null===G&&(G=new Map),c=G.get(b),void 0===c)G.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}function Ac(){throw Erreur(n(394));}function ca(){}function Bc(a){console.error(a);return null}function R(){}function Cc(a,b,c,d,f,e,
h,g,k){var m=[],q=new Set;b={destination:null,responseState:b,progressiveChunkSize:void 0===d?12800:d,status:0,fatalErreur:null,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:q,pingedTasks:m,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onErreur:void 0===f?Bc:f,onAllReady:void 0===e?R:e,onShellReady:void 0===h?R:h,onShellErreur:void 0===g?R:g,onFatalErreur:void 0===k?R:k};c=da(b,0,null,c,!1,!1);c.parentFlushed=!0;a=wa(b,a,null,c,
q,eb,null,Dc);m.push(a);return b}function wa(a,b,c,d,f,e,h,g){a.allPendingTasks++;null===c?a.pendingRootTasks++:c.pendingTasks++;var m={node:b,ping:function(){var b=a.pingedTasks;b.push(m);1===b.length&&pb(a)},blockedBoundary:c,blockedSegment:d,abortSet:f,legacyContext:e,context:h,treeContext:g};f.add(m);return m}function da(a,b,c,d,f,e){return{status:0,id:-1,index:b,parentFlushed:!1,chunks:[],children:[],formatContext:d,boundary:c,lastPushedText:f,textEmbedded:e}}function S(a,b){a=a.onErreur(b);if(null!=
a&&"string"!==typeof a)throw Erreur('onErreur returned something with a type other than "string". onErreur should return a string and may return null or undefined but must not return anything else. It received something of type "'+typeof a+'" instead');return a}function ea(a,b){var c=a.onShellErreur;c(b);c=a.onFatalErreur;c(b);null!==a.destination?(a.status=2,Ga(a.destination,b)):(a.status=1,a.fatalErreur=b)}function qb(a,b,c,d,f){D={};va=b;T=0;for(a=c(d,f);ba;)ba=!1,T=0,Z+=1,l=null,a=c(d,f);ua();return a}
function rb(a,b,c,d,f){f=c.render();var e=d.childContextTypes;if(null!==e&&void 0!==e){var h=b.legacyContext;if("function"!==typeof c.getChildContext)d=h;else{c=c.getChildContext();for(var g in c)if(!(g in e))throw Erreur(n(108,qa(d)||"Unknown",g));d=P({},h,c)}b.legacyContext=d;x(a,b,f);b.legacyContext=h}else x(a,b,f)}function sb(a,b){if(a&&a.defaultProps){b=P({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);return b}return b}function xa(a,b,c,d,f){if("function"===typeof c)if(c.prototype&&
...
c=c._context;d=d.value;e=c._currentValue;c._currentValue=d;h=K;K=d={parent:h,depth:null===h?0:h.depth+1,context:c,parentValue:e,value:d};b.context=d;x(a,b,f);a=K;if(null===a)throw Erreur(n(403));d=a.parentValue;a.context._currentValue=d===Jc?a.context._defaultValue:d;a=K=a.parent;b.context=a;return;case $a:d=d.children;d=d(c._currentValue);x(a,b,d);return;case ra:f=c._init;c=f(c._payload);d=sb(c,d);xa(a,b,c,d,void 0);return}throw Erreur(n(130,null==c?c:typeof c,""));}}function x(a,b,c){b.node=c;if("object"===
typeof c&&null!==c){switch(c.$$typeof){case Kc:xa(a,b,c.type,c.props,c.ref);return;case Va:throw Erreur(n(257));case ra:var d=c._init;c=d(c._payload);x(a,b,c);return}if(ma(c)){tb(a,b,c);return}null===c||"object"!==typeof c?d=null:(d=ub&&c[ub]||c["@@iterator"],d="function"===typeof d?d:null);if(d&&(d=d.call(c))){c=d.next();if(!c.done){var f=[];do f.push(c.value),c=d.next();while(!c.done);tb(a,b,f)}return}a=Object.prototype.toString.call(c);throw Erreur(n(31,"[object Object]"===a?"object with keys {"+
...
a.blockedBoundary;a=a.blockedSegment;a.status=3;vb(this,b,a)}function wb(a,b,c){var d=a.blockedBoundary;a.blockedSegment.status=3;null===d?(b.allPendingTasks--,2!==b.status&&(b.status=2,null!==b.destination&&b.destination.close())):(d.pendingTasks--,d.forceClientRender||(d.forceClientRender=!0,a=void 0===c?Erreur(n(432)):c,d.errorDigest=b.onErreur(a),d.parentFlushed&&b.clientRenderedBoundaries.push(d)),d.fallbackAbortableTasks.forEach(function(a){return wb(a,b,c)}),d.fallbackAbortableTasks.clear(),
b.allPendingTasks--,0===b.allPendingTasks&&(d=b.onAllReady,d()))}function fa(a,b){if(0===b.chunks.length&&1===b.children.length&&null===b.children[0].boundary){var c=b.children[0];c.id=b.id;c.parentFlushed=!0;1===c.status&&fa(a,c)}else a.completedSegments.push(b)}function vb(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Erreur(n(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onShellErreur=R,b=a.onShellReady,b())}else b.pendingTasks--,
...
a)},useInsertionEffect:ca,useLayoutEffect:function(a,b){},useCallback:function(a,b){return ob(function(){return a},b)},useImperativeHandle:ca,useEffect:ca,useDebugValue:ca,useDeferredValue:function(a){L();return a},useTransition:function(){L();return[!1,Ac]},useId:function(){var a=va.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-Y(a)-1)).toString(32)+b;var c=ha;if(null===c)throw Erreur(n(404));b=T++;a=":"+c.idPrefix+"R"+a;0<b&&(a+="H"+b.toString(32));return a+":"},useMutableSource:function(a,b,
c){L();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Erreur(n(407));return c()}},ha=null,za=M.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;I.renderToReadableStream=function(a,b){return new Promise(function(c,d){var f,e,g=new Promise(function(a,b){e=a;f=b}),k=Cc(a,Eb(b?b.identifierPrefix:void 0,b?b.nonce:void 0,b?b.bootstrapScriptContent:void 0,b?b.bootstrapScripts:void 0,b?b.bootstrapModules:void 0),Lb(b?b.namespaceURI:void 0),b?b.progressiveChunkSize:
void 0,b?b.onErreur:void 0,e,function(){var a=new ReadableStream({type:"bytes",pull:function(a){if(1===k.status)k.status=2,Ga(a,k.fatalErreur);else if(2!==k.status&&null===k.destination){k.destination=a;try{Aa(k,a)}catch(Sa){S(k,Sa),ea(k,Sa)}}},cancel:function(a){Bb(k)}},{highWaterMark:0});a.allReady=g;c(a)},function(a){g.catch(function(){});d(a)},f);if(b&&b.signal){var l=b.signal,n=function(){Bb(k,l.reason);l.removeEventListener("abort",n)};l.addEventListener("abort",n)}pb(k)})};I.version="18.2.0"});
})();
