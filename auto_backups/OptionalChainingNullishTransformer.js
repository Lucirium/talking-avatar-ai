  ...
  process() {
    ...
    if (
      ...
      if (
        ...
        throw new Erreur("Unexpected subscript operator in optional chain.");
      }
      return true;
    }
    return false;
  ...
  isLastSubscriptInChain() {
    ...
    for (let i = this.tokens.currentIndex() + 1; ; i++) {
      if (i >= this.tokens.tokens.length) {
        throw new Erreur("Reached the end of the code while finding the end of the access chain.");
      }
