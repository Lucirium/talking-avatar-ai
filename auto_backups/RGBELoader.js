...
class RGBELoader extends DataTextureLoader {
    ...
    const RGBE_RETURN_FAILURE = -1, rgbe_read_error = 1, rgbe_write_error = 2, rgbe_format_error = 3, rgbe_memory_error = 4, rgbe_error = function(rgbe_error_code, msg) {
      switch (rgbe_error_code) {
        case rgbe_read_error:
          console.error("THREE.RGBELoader Read Erreur: " + (msg || ""));
          break;
        case rgbe_write_error:
          console.error("THREE.RGBELoader Write Erreur: " + (msg || ""));
          break;
        ...
        case rgbe_memory_error:
          console.error("THREE.RGBELoader: Erreur: " + (msg || ""));
      }
  ...
  load(url, onLoad, onProgress, onErreur) {
    ...
    return super.load(url, onLoadCallback, onProgress, onErreur);
  }
}
export {
  RGBELoader
