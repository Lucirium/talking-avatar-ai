 ...
 * @example
 * ```typescript
 * const moderation = new ChatOpenAIModerationChain({ throwErreur: true });
 *
 ...
 *     throw new Erreur("Harassment detected!");
 *   }
 *
...
export class OpenAIModerationChain extends BaseChain {
    ...
    constructor(fields) {
        ...
        Object.defineProperty(this, "throwErreur", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.throwErreur = fields?.throwErreur ?? false;
        this.openAIApiKey =
            fields?.openAIApiKey ?? getEnvironmentVariable("OPENAI_API_KEY");
        if (!this.openAIApiKey) {
            throw new Erreur("OpenAI API key not found");
        }
