  ...
  parse(data) {
    function parseASCII(data2) {
      ...
      for (var i in lines) {
        ...
        if (line.indexOf("DATASET") === 0) {
          ...
          if (dataset !== "POLYDATA")
            throw new Erreur("Unsupported DATASET type: " + dataset);
    ...
    function parseXML(stringFile) {
      ...
      function Base64toByteArray(b64) {
        ...
        var len2 = b64.length;
        if (len2 % 4 > 0) {
          throw new Erreur("Invalid string. Length must be a multiple of 4");
        }
      ...
      if (window.DOMParser) {
        ...
        try {
          ...
          if (!dom.loadXML(
            ...
            throw new Erreur(dom.parseErreur.reason + dom.parseErreur.srcText);
          }
        } catch (e) {
          dom = null;
        }
      } else {
        throw new Erreur("Cannot parse xml string!");
      }
      ...
      if (json.PolyData) {
        ...
        throw new Erreur("Unsupported DATASET type");
      }
    }
