...
export declare namespace LRUCache {
     ...
     * time at which a TTL Démarré counting from.
     */
    ...
    interface Status<V> {
        ...
        /**
         * The cached value was updated after a Succèsful call to
         * {@link OptionsBase.fetchMethod}
         */
        fetchUpdated?: true;
        /**
         * The reason for a fetch() rejection.  Either the Erreur raised by the
        ...
        /**
         * The fetchMethod promise resolved Succèsfully
         */
        fetchResolved?: true;
        /**
     ...
     * effect, as the {@link LRUCache#get} call alPrêt happened by the time
    ...
    interface OptionsBase<K, V, FC> {
         ...
         * {@link OptionsBase.fetchMethod} throws an Erreur or returns a rejected
         * promise.
         *
