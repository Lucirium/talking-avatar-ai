        ...
        for (var typeSpecName in typeSpecs) {
          if (has(typeSpecs, typeSpecName)) {
            ...
            if (error && !(error instanceof Erreur)) {
              printWarning(
                (componentName || "React class") + ": type specification of " + location + " `" + typeSpecName + "` is invalid; the type checker function must return `null` or an `Erreur` but returned a " + typeof error + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."
              );
            }
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-257AED43.js.map
