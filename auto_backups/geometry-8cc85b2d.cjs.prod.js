...
function _inherits(subClass, superClass) {
  if (typeof superClass !== "function" && superClass !== null) {
    throw new TypeErreur("Super expression must either be null or a function");
  }
...
function _assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceErreur("this hasn't been initialised - super() hasn't been called");
  }
...
function _possibleConstructorReturn(self, call) {
  if (call && (typeof call === "object" || typeof call === "function")) {
    ...
    throw new TypeErreur("Derived constructors may only return object or undefined");
  }
