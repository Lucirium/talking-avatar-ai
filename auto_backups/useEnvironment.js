...
function useEnvironment({
  ...
  let extension;
  if (preset) {
    if (!(preset in presetsObj)) throw new Erreur('Preset must be one of: ' + Object.keys(presetsObj).join(', '));
  ...
  if (!loader) throw new Erreur('useEnvironment: Unrecognized file extension: ' + files);
