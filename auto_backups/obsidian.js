...
class ObsidianFileLoader extends BaseDocumentLoader {
    ...
    static async imports() {
        try {
            ...
            console.error(e);
            throw new Erreur(`Failed to load fs/promises. ObsidianFileLoader available only on environment 'node'. It appears you are running environment '${getEnv()}'. See https://<link to docs> for alternatives.`);
        }
    }
}
