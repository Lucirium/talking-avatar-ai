        ...
        try {
            ...
            const objectData = await new Promise((resolve, reject) => {
                ...
                if (response.Body instanceof Readable) {
                    ...
                    reject(new Erreur("Response body is not a readable stream."));
                }
            });
            ...
            throw new Erreur(`Failed to download file ${this.key} from S3 bucket ${this.bucket}: ${e.message}`);
        }
        try {
            const options = {
            ...
            throw new Erreur(`Failed to load file ${filePath} using unstructured loader.`);
        }
    }
}
