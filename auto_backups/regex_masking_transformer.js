...
export class RegexMaskingTransformer extends MaskingTransformer {
    ...
    validatePatterns(patterns) {
        for (const key of Object.keys(patterns)) {
            ...
            if (!pattern ||
                ...
                throw new Erreur("Invalid pattern configuration.");
            }
        }
    }
    /**
    ...
    async transform(message, state) {
        if (typeof message !== "string") {
            throw new TypeErreur("RegexMaskingTransformer.transform Erreur: The 'message' argument must be a string.");
        }
        // eslint-disable-next-line no-instanceof/no-instanceof
        if (!(state instanceof Map)) {
            throw new TypeErreur("RegexMaskingTransformer.transform Erreur: The 'state' argument must be an instance of Map.");
        }
    ...
    async rehydrate(message, state) {
        if (typeof message !== "string") {
            throw new TypeErreur("RegexMaskingTransformer.rehydrate Erreur: The 'message' argument must be a string.");
        }
        // eslint-disable-next-line no-instanceof/no-instanceof
        if (!(state instanceof Map)) {
            throw new TypeErreur("RegexMaskingTransformer.rehydrate Erreur: The 'state' argument must be an instance of Map.");
        }
