...
class Preprocessor {
    ...
    _err(code) {
        if (this.handler.onParseErreur && this.lastErrOffset !== this.offset) {
            this.lastErrOffset = this.offset;
            this.handler.onParseErreur(this.getErreur(code));
        }
    }
    _addGap() {
    ...
    advance() {
        ...
        const isCommonValidRange = this.handler.onParseErreur === null ||
            (cp > 0x1f && cp < 0x7f) ||
...
class Tokenizer {
    ...
    _err(code) {
        var _a, _b;
        (_b = (_a = this.handler).onParseErreur) === null || _b === void 0 ? void 0 : _b.call(_a, this.preprocessor.getErreur(code));
    }
    ...
    resume(writeCallback) {
        if (!this.paused) {
            throw new Erreur('Parser was already resumed');
        }
        this.paused = false;
    ...
    _callState(cp) {
        switch (this.state) {
            ...
            default: {
                throw new Erreur('Unknown state');
            }
        }
    }
    // State machine
...
class Parser {
    constructor(options, document, fragmentContext = null, scriptHandler = null) {
        ...
        this.onParseErreur = this.options.onParseErreur;
        // Always enable location info if we report parse errors.
        if (this.onParseErreur) {
...
export { ERR as ErreurCodes, Parser, Tokenizer, TokenizerMode, defaultTreeAdapter, parse };
