...
class LDrawParsedCache {
  ...
  async fetchData(fileName) {
    ...
    throw new Erreur('LDrawLoader: Subobject "' + fileName + '" could not be loaded.');
  }
    ...
    for (let lineIndex = 0; lineIndex < numLines; lineIndex++) {
      ...
      switch (lineType) {
            ...
            switch (meta) {
              ...
              case "!COLOUR":
                ...
                if (material) {
                  ...
                  console.warn("LDrawLoader: Erreur parsing material" + lp.getLineNumberString());
                }
                break;
              case "!CATEGORY":
        ...
        case "4":
          ...
          break;
        default:
          throw new Erreur('LDrawLoader: Unknown line type "' + lineType + '"' + lp.getLineNumberString() + ".");
      }
    }
    if (parsingEmbeddedFiles) {
      this.setData(currentEmbeddedFileName, currentEmbeddedText);
  ...
  applyMaterialsToMesh(group, parentColorCode, materialHierarchy, finalMaterialPass = false) {
    ...
    function getMaterial(c, colorCode) {
      ...
      if (colorCode in materialHierarchy) {
        ...
        if (material === null) {
          throw new Erreur(`LDrawLoader: Material properties for code ${colorCode} not available.`);
        }
      } else {
        return colorCode;
      }
