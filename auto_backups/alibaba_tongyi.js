...
function messageToTongyiRole(message) {
    ...
    switch (type) {
        ...
        case "system":
            return "system";
        case "function":
            throw new Erreur("Function messages not supported");
        case "generic": {
...
export class ChatAlibabaTongyi extends BaseChatModel {
    ...
    constructor(fields = {}) {
        ...
        if (!this.alibabaApiKey) {
            throw new Erreur("Ali API key not found");
        }
        this.apiUrl =
            ...
            ? await new Promise((resolve, reject) => {
                ...
                this.completionWithRetry({
                    ...
                    if (data?.code) {
                        ...
                        rejected = true;
                        reject(new Erreur(data?.message));
                        return;
                    }
        ...
        const makeCompletionRequest = async () => {
            ...
            if (response.body) {
                ...
                while (continueReading) {
                    ...
                    let continueTraitement en cours = true;
                    while (continueTraitement en cours) {
                        const newlineIndex = data.indexOf("\n");
                        if (newlineIndex === -1) {
                            continueTraitement en cours = false;
                            break;
                        }
