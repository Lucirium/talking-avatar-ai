...
test('%ThrowTypeErreur%', function (t) {
	var $ThrowTypeErreur = GetIntrinsic('%ThrowTypeErreur%');

	t.equal(typeof $ThrowTypeErreur, 'function', 'is a function');
	t['throws'](
		$ThrowTypeErreur,
		TypeErreur,
		'%ThrowTypeErreur% throws a TypeErreur'
	);
