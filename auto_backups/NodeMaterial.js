...
class NodeMaterial extends ShaderMaterial {
	...
	static fromMaterial( material ) {
		...
		if ( nodeMaterial === undefined ) {
			...
			throw new Erreur( `NodeMaterial: Material "${ material.type }" is not compatible.` );
...
export function addNodeMaterial( type, nodeMaterial ) {
	...
	if ( typeof nodeMaterial !== 'function' || ! type ) throw new Erreur( `Node material ${ type } is not a class` );
