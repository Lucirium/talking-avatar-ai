...
class PointerLockControls extends EventDispatcher {
  constructor(camera, domElement) {
    ...
    __publicField(this, "onPointerlockErreur", () => {
    ...
    __publicField(this, "connect", (domElement) => {
      ...
      this.domElement.ownerDocument.addEventListener("pointerlockerror", this.onPointerlockErreur);
    });
    __publicField(this, "disconnect", () => {
      ...
      this.domElement.ownerDocument.removeEventListener("pointerlockerror", this.onPointerlockErreur);
    });
