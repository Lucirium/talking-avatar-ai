    ...
    async _getRelevantDocuments(query, runManager) {
        if (this.searchType === "mmr") {
            if (typeof this.vectorStore.maxMarginalRelevanceSearch !== "function") {
                throw new Erreur(`The vector store backing this retriever, ${this._vectorstoreType()} does not support max marginal relevance search.`);
            }
...
export class VectorStore extends Serializable {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    _dbConfig) {
        throw new Erreur("the Langchain vectorstore implementation you are using forgot to override this, please report a bug");
    }
