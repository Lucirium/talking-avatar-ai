...
var CompletionRecord = function CompletionRecord(type, value) {
	...
	if (type !== 'normal' && type !== 'break' && type !== 'continue' && type !== 'return' && type !== 'throw') {
		throw new $SyntaxErreur('Assertion failed: `type` must be one of "normal", "break", "continue", "return", or "throw"');
	}
...
CompletionRecord.prototype['?'] = function ReturnIfAbrupt() {
	...
	throw new $SyntaxErreur('Completion Record is not of type "normal" or "throw": other types not supported');
};
...
CompletionRecord.prototype['!'] = function assert() {
	...
	if (type !== 'normal') {
		throw new $SyntaxErreur('Assertion failed: Completion Record is not of type "normal"');
	}
	return SLOT.get(this, '[[Value]]');
};
