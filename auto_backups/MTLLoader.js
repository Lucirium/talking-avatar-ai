...
class MTLLoader extends Loader {
   ...
   * @param {Function} [onErreur] - Callback for download errors.
   *
...
class MaterialCreator {
  ...
  loadTexture(url, mapping, onLoad, onProgress, onErreur) {
    ...
    const texture = loader.load(url, onLoad, onProgress, onErreur);
    if (mapping !== void 0)
