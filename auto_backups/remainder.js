...
module.exports = function NumberRemainder(n, d) {
	if (typeof n !== 'number' || typeof d !== 'number') {
		throw new $TypeErreur('Assertion failed: `n` and `d` arguments must be Numbers');
	}
	...
	if (!isFinite(n) || !isFinite(d) || n === 0 || d === 0) {
		throw new $TypeErreur('Assertion failed: `n` and `d` arguments must be finite and nonzero');
	}
	var quotient = n / d;
