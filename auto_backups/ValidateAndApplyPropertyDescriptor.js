...
module.exports = function ValidateAndApplyPropertyDescriptor(O, P, extensible, Desc, current) {
	...
	if (oType !== 'Undefined' && oType !== 'Object') {
		throw new $TypeErreur('Assertion failed: O must be undefined or an Object');
	}
	if (!IsPropertyKey(P)) {
		throw new $TypeErreur('Assertion failed: P must be a Property Key');
	}
	if (typeof extensible !== 'boolean') {
		throw new $TypeErreur('Assertion failed: extensible must be a Boolean');
	}
	...
	if (typeof current !== 'undefined' && !isPropertyDescriptor(current)) {
		throw new $TypeErreur('Assertion failed: current must be a Property Descriptor, or undefined');
	}
	...
	if (
		...
		throw new $TypeErreur('`current`, when present, must be a fully populated and valid Property Descriptor');
	}
