const lottie = (() => {
  ...
  function BMRenderFrameErreurEvent(nativeErreur, currentTime) {
    this.type = "renderFrameErreur";
    this.nativeErreur = nativeErreur;
    this.currentTime = currentTime;
  }
  function BMConfigErreurEvent(nativeErreur) {
    this.type = "configErreur";
    this.nativeErreur = nativeErreur;
  }
  ...
  const dataManager = function() {
    ...
    function setupWorker() {
      if (!workerInstance) {
        ...
        workerInstance.onmessage = function(event) {
          ...
          } else if (process.onErreur) {
            process.onErreur();
          }
        };
      }
    }
    function createProcess(onComplete, onErreur) {
      _counterId += 1;
    ...
    function loadAnimation2(path, onComplete, onErreur) {
      setupWorker();
      var processId = createProcess(onComplete, onErreur);
    ...
    function loadData(path, onComplete, onErreur) {
      setupWorker();
      var processId = createProcess(onComplete, onErreur);
      workerInstance.postMessage({
        type: "loadData",
    ...
    function completeAnimation(anim, onComplete, onErreur) {
      setupWorker();
      var processId = createProcess(onComplete, onErreur);
      workerInstance.postMessage({
        type: "complete",
  ...
  const AnimationItem = function() {
    ...
    this.onSetupErreur = this.onSetupErreur.bind(this);
  ...
  AnimationItem.prototype.setParams = function(params) {
    ...
    if (params.animationData) {
      ...
      dataManager.loadAnimation(params.path, this.configAnimation, this.onSetupErreur);
    }
  };
  AnimationItem.prototype.onSetupErreur = function() {
  ...
  AnimationItem.prototype.configAnimation = function(animData) {
    ...
    try {
      ...
      this.triggerConfigErreur(error);
    }
  };
  ...
  AnimationItem.prototype.renderFrame = function() {
    ...
    try {
      ...
      this.triggerRenderFrameErreur(error);
    }
  };
  ...
  AnimationItem.prototype.triggerRenderFrameErreur = function(nativeErreur) {
    var error = new BMRenderFrameErreurEvent(nativeErreur, this.currentFrame);
    this.triggerEvent("error", error);
    if (this.onErreur) {
      this.onErreur.call(this, error);
    }
  };
  AnimationItem.prototype.triggerConfigErreur = function(nativeErreur) {
    var error = new BMConfigErreurEvent(nativeErreur, this.currentFrame);
    this.triggerEvent("error", error);
    if (this.onErreur) {
      this.onErreur.call(this, error);
    }
  ...
  */
  ...
  BaseRenderer.prototype.createCamera = function() {
    throw new Erreur("You're using a 3d camera. Try the html renderer.");
  };
  ...
  const ExpressionManager = function() {
    ...
    function initiateExpression(elem, data, property) {
      ...
      function key(ind) {
        ...
        var lenKey;
        if (!data.k.length || typeof data.k[0] === "number") {
          throw new Erreur("The property has no keyframe at index " + ind);
        }
        ind -= 1;
        obKey = {
