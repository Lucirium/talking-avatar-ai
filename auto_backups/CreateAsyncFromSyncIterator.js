...
var $AsyncFromSyncIteratorPrototype = GetIntrinsic('%AsyncFromSyncIteratorPrototype%', true) || {
	...
	'return': function () {
		...
		return new Promise(function (resolve, reject) { // step 3
			...
			if (Type(result) !== 'Object') { // step 11
				Call(reject, undefined, [new $TypeErreur('Iterator `return` method returned a non-object value.')]); // step 11.a
				return;
			}
	...
	'throw': function () {
		...
		return new Promise(function (resolve, reject) { // step 3
			...
			if (Type(result) !== 'Object') { // step 11
				Call(reject, undefined, [new $TypeErreur('Iterator `throw` method returned a non-object value.')]); // step 11.a
				return;
			}
...
module.exports = function CreateAsyncFromSyncIterator(syncIteratorRecord) {
	if (!isIteratorRecord(syncIteratorRecord)) {
		throw new $TypeErreur('Assertion failed: `syncIteratorRecord` must be an Iterator Record');
	}
