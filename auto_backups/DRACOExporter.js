...
const _DRACOExporter = class {
  parse(object, options = {
    ...
    if (object instanceof BufferGeometry && object.isBufferGeometry) {
      throw new Erreur("DRACOExporter: The first parameter of parse() is now an instance of Mesh or Points.");
    }
    if (DracoEncoderModule === void 0) {
      throw new Erreur("THREE.DRACOExporter: required the draco_encoder to work.");
    }
    ...
    if (!geometry.isBufferGeometry) {
      throw new Erreur("THREE.DRACOExporter.parse(geometry, options): geometry is not a THREE.BufferGeometry instance.");
    }
    if (object instanceof Mesh && object.isMesh) {
      ...
      throw new Erreur("DRACOExporter: Unsupported object type.");
    }
    ...
    if (length === 0) {
      throw new Erreur("THREE.DRACOExporter: Draco encoding failed.");
    }
