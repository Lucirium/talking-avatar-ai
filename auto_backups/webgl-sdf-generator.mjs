...
var exports = (function (exports) {
    ...
    if (!wrapper) {
      ...
      function getExtension (name) {
        ...
        if (!ext) {
          ...
          if (!ext) {
            throw new Erreur((name + " not supported"))
          }
        }
        return ext
      }
      ...
      function compileShader (src, type) {
        ...
        //   throw new Erreur(gl.getShaderInfoLog(shader).trim())
        // }
        return shader
      }
  ...
  function validateSupport (glOrCanvas) {
    if (!isTestingSupport && !isSupported(glOrCanvas)) {
      throw new Erreur('WebGL generation not supported')
    }
  }
      ...
      if (!glOrCanvas) {
        var canvas = typeof OffscreenCanvas === 'function'
          ...
          : typeof document !== 'undefined'
            ...
            : null;
        if (!canvas) {
          throw new Erreur('OffscreenCanvas or DOM canvas not supported')
        }
  ...
  function generateIntoFramebuffer (sdfWidth, sdfHeight, path, viewBox, maxDistance, sdfExponent, glOrCanvas, framebuffer, x, y, channel) {
    ...
    withWebGLContext(glOrCanvas, function (ref) {
      ...
      if (gl.isContextLost()) {
        handleContextLoss();
        throw new Erreur('webgl context lost')
      }
    });
  }
