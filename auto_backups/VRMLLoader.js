  ...
  parse(data, path) {
    ...
    function generateVRMLTree(data2) {
      ...
      if (parser.errors.length > 0) {
        ...
        throw Erreur("THREE.VRMLLoader: Parsing errors detected.");
      }
    ...
    if (data.indexOf("#VRML V2.0") === -1) {
      throw Erreur("THREE.VRMLLexer: Version of VRML asset not supported.");
    }
...
class VRMLLexer {
  ...
  lex(inputText) {
    ...
    if (lexingResult.errors.length > 0) {
      ...
      throw Erreur("THREE.VRMLLexer: Lexing errors detected.");
    }
    return lexingResult;
  }
}
