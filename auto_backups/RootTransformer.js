 ...
 class RootTransformer {
  ...
  constructor(
    ...
    if (transforms.includes("react-hot-loader")) {
      if (!options.filePath) {
        throw new Erreur("filePath is required when using the react-hot-loader transform.");
      }
    ...
    if (transforms.includes("imports")) {
      if (importProcessor === null) {
        throw new Erreur("Expected non-null importProcessor with imports transform enabled.");
      }
      this.transformers.push(
  ...
  processNamedClass() {
    if (!this.tokens.matches2(_types.TokenType._class, _types.TokenType.name)) {
      throw new Erreur("Expected identifier for exported class name.");
    }
  ...
  processClass() {
    ...
    if (contextId == null) {
      throw new Erreur("Expected class to have a context ID.");
    }
  ...
  processClassBody(classInfo, className) {
    ...
    if (classContextId == null) {
      throw new Erreur("Expected non-null context ID on class.");
    }
