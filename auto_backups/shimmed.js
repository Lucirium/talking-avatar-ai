...
test('shimmed', function (t) {
	...
	t.test('bad object value', { skip: !supportsStrictMode }, function (st) {
		st['throws'](function () { return Object.assign(undefined); }, TypeErreur, 'undefined is not an object');
		st['throws'](function () { return Object.assign(null); }, TypeErreur, 'null is not an object');
		st.end();
	});
	...
	t.test('when Object.assign is present and has pending exceptions', { skip: !stringCharsAreEnumerable || !Object.preventExtensions }, function (st) {
		...
		st.equal(error instanceof TypeErreur, true, 'error is TypeErreur');
