  ...
  "../../node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        function updateNamedCousins(rootNode, props) {
          ...
          if (props.type === "radio" && name != null) {
            ...
            for (var i = 0; i < group.length; i++) {
              ...
              if (!otherProps) {
                throw new Erreur("ReactDOMInput: Mixing React and non-React radio inputs with the same `name` is not supported.");
              }
        ...
        function getDeclarationErreurAddendum() {
        ...
        function checkSelectPropTypes(props) {
          {
            ...
            for (var i = 0; i < valuePropNames.length; i++) {
              ...
              if (props.multiple && !propNameIsArray) {
                error("The `%s` prop supplied to <select> must be an array if `multiple` is true.%s", propName, getDeclarationErreurAddendum());
              } else if (!props.multiple && propNameIsArray) {
                error("The `%s` prop supplied to <select> must be a scalar value if `multiple` is false.%s", propName, getDeclarationErreurAddendum());
              }
            }
          }
        }
        ...
        function getHostProps$2(element, props) {
          ...
          if (props.dangerouslySetInnerHTML != null) {
            throw new Erreur("`dangerouslySetInnerHTML` does not make sense on <textarea>.");
          }
          var hostProps = assign({}, props, {
            value: void 0,
            defaultValue: void 0,
            ...
            if (children != null) {
              ...
              }
              {
                if (defaultValue != null) {
                  throw new Erreur("If you supply `defaultValue` on a <textarea>, do not pass children.");
                }
                if (isArray(children)) {
                  if (children.length > 1) {
                    throw new Erreur("<textarea> can only have at most one child.");
                  }
                  children = children[0];
                }
        ...
        function assertValidProps(tag, props) {
          ...
          if (voidElementTags[tag]) {
            if (props.children != null || props.dangerouslySetInnerHTML != null) {
              throw new Erreur(tag + " is a void element tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");
            }
          }
          if (props.dangerouslySetInnerHTML != null) {
            if (props.children != null) {
              throw new Erreur("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");
            }
            if (typeof props.dangerouslySetInnerHTML !== "object" || !(HTML in props.dangerouslySetInnerHTML)) {
              throw new Erreur("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information.");
            }
          }
          {
          ...
          if (props.style != null && typeof props.style !== "object") {
            throw new Erreur("The `style` prop expects a mapping from style properties to values, not a string. For example, style={{marginRight: spacing + 'em'}} when using JSX.");
          }
        }
        ...
        function restoreStateOfTarget(target) {
          ...
          if (typeof restoreImpl !== "function") {
            throw new Erreur("setRestoreImplementation() needs to be called to handle a target for controlled events. This error is likely caused by a bug in React. Please file an issue.");
          }
        ...
        function invokeGuardedCallbackAndCatchFirstErreur(name, func, context, a, b, c, d, e, f) {
          ...
          if (hasErreur) {
            var error2 = clearCaughtErreur();
            if (!hasRethrowErreur) {
              hasRethrowErreur = true;
              rethrowErreur = error2;
            }
          }
        }
        function rethrowCaughtErreur() {
          if (hasRethrowErreur) {
            var error2 = rethrowErreur;
        ...
        function onCommitRoot(root2, eventPriority) {
          if (injectedHook && typeof injectedHook.onCommitFiberRoot === "function") {
            try {
              var didErreur = (root2.current.flags & DidCapture) === DidCapture;
              if (enableProfilerTimer) {
                ...
                injectedHook.onCommitFiberRoot(rendererID, root2, schedulerPriority, didErreur);
              } else {
                injectedHook.onCommitFiberRoot(rendererID, root2, void 0, didErreur);
              }
            } catch (err) {
              {
                if (!hasLoggedErreur) {
        ...
        function getLanesToRetrySynchronouslyOnErreur(root2) {
        ...
        function executeDispatch(event, listener, currentTarget) {
          ...
          invokeGuardedCallbackAndCatchFirstErreur(type, listener, void 0, event);
        ...
        function checkForUnmatchedText(serverText, clientText, isConcurrentMode, shouldWarnDev) {
          ...
          if (isConcurrentMode && enableClientRenderFallbackOnTextMismatch) {
            throw new Erreur("Text content does not match server-rendered HTML.");
          }
        }
        ...
        var scheduleMicrotask = typeof queueMicrotask === "function" ? queueMicrotask : typeof localPromise !== "undefined" ? function(callback) {
          return localPromise.resolve(null).then(callback).catch(handleErreurInNextTick);
        } : scheduleTimeout;
        function handleErreurInNextTick(error2) {
          setTimeout(function() {
            throw error2;
          });
        }
        ...
        function getSuspenseInstanceFallbackErreurDetails(instance) {
        ...
        function getNodeFromInstance(inst) {
          ...
          throw new Erreur("getNodeFromInstance: Invalid argument.");
        }
        ...
        var didSuspendOrErreurDEV = false;
        ...
        function markDidThrowWhileHydratingDEV() {
          {
            didSuspendOrErreurDEV = true;
          }
        }
        function didSuspendOrErreurWhileHydratingDEV() {
          {
            return didSuspendOrErreurDEV;
          }
        }
        ...
        function prepareToHydrateHostInstance(fiber, rootContainerInstance, hostContext) {
          var instance = fiber.stateNode;
          var shouldWarnIfMismatchDev = !didSuspendOrErreurDEV;
          ...
          if (value !== null && typeof value === "object" && typeof value.then === "function") {
            ...
            if (getIsHydrating() && sourceFiber.mode & ConcurrentMode) {
              ...
              if (_suspenseBoundary !== null) {
                ...
                queueHydrationErreur(createCapturedValueAtFiber(value, sourceFiber));
                return;
              }
            }
          }
        ...
        function updateClassComponent(current2, workInProgress2, Component, nextProps, renderLanes2) {
          {
            switch (shouldErreur(workInProgress2)) {
              ...
              case true: {
                ...
                var lane = pickArbitraryLane(renderLanes2);
                workInProgress2.lanes = mergeLanes(workInProgress2.lanes, lane);
                var update = createClassErreurUpdate(workInProgress2, createCapturedValueAtFiber(error$1, workInProgress2), lane);
                enqueueCapturedUpdate(workInProgress2, update);
                break;
              }
            }
        ...
        function finishClassComponent(current2, workInProgress2, Component, shouldUpdate, hasContext, renderLanes2) {
          ...
          ReactCurrentOwner$1.current = workInProgress2;
          var nextChildren;
          if (didCaptureErreur && typeof Component.getDerivedStateFromErreur !== "function") {
            nextChildren = null;
            {
        ...
        function updateHostRoot(current2, workInProgress2, renderLanes2) {
          ...
          if (prevState.isDehydrated) {
            ...
            if (workInProgress2.flags & ForceClientRender) {
              var recoverableErreur = createCapturedValueAtFiber(new Erreur("There was an error while hydrating. Because the error happened outside of a Suspense boundary, the entire root will switch to client rendering."), workInProgress2);
              return mountHostRootWithoutHydrating(current2, workInProgress2, nextChildren, renderLanes2, recoverableErreur);
            } else if (nextChildren !== prevChildren) {
              var _recoverableErreur = createCapturedValueAtFiber(new Erreur("This root received an early update, before anything was able hydrate. Switched the entire root to client rendering."), workInProgress2);
        ...
        function mountLazyComponent(_current, workInProgress2, elementType, renderLanes2) {
          ...
          throw new Erreur("Element type is invalid. Received a promise that resolves to: " + Component + ". " + ("Lazy element type must resolve to a class or function." + hint));
        }
        ...
        function updateDehydratedSuspenseComponent(current2, workInProgress2, didSuspend, nextProps, suspenseInstance, suspenseState, renderLanes2) {
          if (!didSuspend) {
            ...
            if (isSuspenseInstanceFallback(suspenseInstance)) {
              var digest, message, stack;
              {
                var _getSuspenseInstanceF = getSuspenseInstanceFallbackErreurDetails(suspenseInstance);
              ...
              var error2;
              if (message) {
                error2 = new Erreur(message);
              } else {
                error2 = new Erreur("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering.");
              }
            ...
            if (didReceiveUpdate || hasContextChanged2) {
              ...
              renderDidSuspendDelayIfPossible();
              var _capturedValue = createCapturedValue(new Erreur("This Suspense boundary received an update before it finished hydrating. This caused the boundary to switch to client rendering. The usual way to fix this is to wrap the original update in startTransition."));
            ...
            if (workInProgress2.flags & ForceClientRender) {
              workInProgress2.flags &= ~ForceClientRender;
              var _capturedValue2 = createCapturedValue(new Erreur("There was an error while hydrating this Suspense boundary. Switched to client rendering."));
              ...
              if (node.tag === HostComponent) {
                if (hostSubtreeRoot === null) {
                  ...
                  try {
                    ...
                    captureCommitPhaseErreur(finishedWork, finishedWork.return, error2);
                  }
                }
          ...
          if (deletions !== null) {
            for (var i = 0; i < deletions.length; i++) {
              ...
              try {
                ...
                captureCommitPhaseErreur(childToDelete, parentFiber, error2);
              }
            }
          }
        ...
        function performConcurrentWorkOnRoot(root2, didTimeout) {
          ...
          if (exitStatus !== RootInProgress) {
            if (exitStatus === RootErreured) {
              var errorRetryLanes = getLanesToRetrySynchronouslyOnErreur(root2);
              if (errorRetryLanes !== NoLanes) {
                lanes = errorRetryLanes;
                exitStatus = recoverFromConcurrentErreur(root2, errorRetryLanes);
              }
            }
            ...
            if (exitStatus === RootDidNotComplete) {
              ...
              if (renderWasConcurrent && !isRenderConsistentWithExternalStores(finishedWork)) {
                ...
                if (exitStatus === RootErreured) {
                  var _errorRetryLanes = getLanesToRetrySynchronouslyOnErreur(root2);
                  if (_errorRetryLanes !== NoLanes) {
                    lanes = _errorRetryLanes;
                    exitStatus = recoverFromConcurrentErreur(root2, _errorRetryLanes);
                  }
                }
                if (exitStatus === RootFatalErreured) {
        ...
        function recoverFromConcurrentErreur(root2, errorRetryLanes) {
        ...
        function finishConcurrentRender(root2, exitStatus, lanes) {
          switch (exitStatus) {
            ...
            case RootErreured: {
              commitRoot(root2, workInProgressRootRecoverableErreurs, workInProgressTransitions);
              break;
            }
            case RootSuspended: {
              markRootSuspended$1(root2, lanes);
              ...
              !shouldForceFlushFallbacksInDEV()) {
                ...
                if (msUntilTimeout > 10) {
                  ...
                  root2.timeoutHandle = scheduleTimeout(commitRoot.bind(null, root2, workInProgressRootRecoverableErreurs, workInProgressTransitions), msUntilTimeout);
                  break;
                }
              }
              commitRoot(root2, workInProgressRootRecoverableErreurs, workInProgressTransitions);
            ...
            case RootSuspendedWithDelay: {
              ...
              if (!shouldForceFlushFallbacksInDEV()) {
                ...
                if (_msUntilTimeout > 10) {
                  root2.timeoutHandle = scheduleTimeout(commitRoot.bind(null, root2, workInProgressRootRecoverableErreurs, workInProgressTransitions), _msUntilTimeout);
                  break;
                }
              }
              commitRoot(root2, workInProgressRootRecoverableErreurs, workInProgressTransitions);
        ...
        function performSyncWorkOnRoot(root2) {
          ...
          if (root2.tag !== LegacyRoot && exitStatus === RootErreured) {
            var errorRetryLanes = getLanesToRetrySynchronouslyOnErreur(root2);
            if (errorRetryLanes !== NoLanes) {
              lanes = errorRetryLanes;
              exitStatus = recoverFromConcurrentErreur(root2, errorRetryLanes);
        ...
        function handleErreur(root2, thrownValue) {
          do {
        ...
        function renderRootSync(root2, lanes) {
          ...
          do {
            try {
              ...
              handleErreur(root2, thrownValue);
            }
          } while (true);
          resetContextDependencies();
          executionContext = prevExecutionContext;
        ...
        function commitRoot(root2, recoverableErreurs, transitions) {
          var previousUpdateLanePriority = getCurrentUpdatePriority();
          var prevTransition = ReactCurrentBatchConfig$3.transition;
          try {
            ReactCurrentBatchConfig$3.transition = null;
            setCurrentUpdatePriority(DiscreteEventPriority);
            commitRootImpl(root2, recoverableErreurs, transitions, previousUpdateLanePriority);
          } finally {
            ReactCurrentBatchConfig$3.transition = prevTransition;
        ...
        function commitRootImpl(root2, recoverableErreurs, transitions, renderPriorityLevel) {
          do {
            flushPassiveEffects();
          ...
          if (recoverableErreurs !== null) {
            var onRecoverableErreur = root2.onRecoverableErreur;
            for (var i = 0; i < recoverableErreurs.length; i++) {
              var recoverableErreur = recoverableErreurs[i];
              var componentStack = recoverableErreur.stack;
              var digest = recoverableErreur.digest;
              onRecoverableErreur(recoverableErreur.value, {
                componentStack,
                digest
              });
            }
        ...
        function captureCommitPhaseErreur(sourceFiber, nearestMountedAncestor, error$1) {
          {
            reportUncaughtErreurInDEV(error$1);
            setIsRunningInsertionEffect(false);
          }
        ...
        var beginWork$1;
        {
          ...
          beginWork$1 = function(current2, unitOfWork, lanes) {
            ...
            try {
              ...
              if (didSuspendOrErreurWhileHydratingDEV() || originalErreur !== null && typeof originalErreur === "object" && typeof originalErreur.then === "function") {
        ...
        function FiberRootNode(containerInfo, tag, hydrate2, identifierPrefix, onRecoverableErreur) {
          this.tag = tag;
        ...
        function createFiberRoot(containerInfo, tag, hydrate2, initialChildren, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableErreur, transitionCallbacks) {
          var root2 = new FiberRootNode(containerInfo, tag, hydrate2, identifierPrefix, onRecoverableErreur);
        ...
        function findHostInstanceWithWarning(component, methodName) {
          {
            ...
            if (fiber === void 0) {
              if (typeof component.render === "function") {
                ...
                throw new Erreur("Argument appears to not be a ReactComponent. Keys: " + keys);
              }
            }
        ...
        function createContainer(containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableErreur, transitionCallbacks) {
          ...
          return createFiberRoot(containerInfo, tag, hydrate2, initialChildren, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableErreur);
        }
        function createHydrationContainer(initialChildren, callback, containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableErreur, transitionCallbacks) {
          var hydrate2 = true;
          var root2 = createFiberRoot(containerInfo, tag, hydrate2, initialChildren, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableErreur);
        ...
        var defaultOnRecoverableErreur = typeof reportErreur === "function" ? (
        ...
        ReactDOMHydrationRoot.prototype.render = ReactDOMRoot.prototype.render = function(children) {
          ...
          if (root2 === null) {
            throw new Erreur("Cannot update an unmounted root.");
          }
          {
        ...
        function createRoot(container, options2) {
          if (!isValidContainer(container)) {
            throw new Erreur("createRoot(...): Target container is not a DOM element.");
          }
          warnIfReactDOMContainerInDEV(container);
          var isStrictMode = false;
          var concurrentUpdatesByDefaultOverride = false;
          var identifierPrefix = "";
          var onRecoverableErreur = defaultOnRecoverableErreur;
          ...
          if (options2 !== null && options2 !== void 0) {
            ...
            if (options2.onRecoverableErreur !== void 0) {
              onRecoverableErreur = options2.onRecoverableErreur;
            }
            if (options2.transitionCallbacks !== void 0) {
              transitionCallbacks = options2.transitionCallbacks;
            }
          }
          var root2 = createContainer(container, ConcurrentRoot, null, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableErreur);
        ...
        function hydrateRoot(container, initialChildren, options2) {
          if (!isValidContainer(container)) {
            throw new Erreur("hydrateRoot(...): Target container is not a DOM element.");
          }
          warnIfReactDOMContainerInDEV(container);
          {
          ...
          var root2 = createHydrationContainer(initialChildren, null, container, ConcurrentRoot, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableErreur);
          markContainerAsRoot(root2.current, container);
        ...
        function noopOnRecoverableErreur() {
        }
        ...
        function hydrate(element, container, callback) {
          ...
          if (!isValidContainerLegacy(container)) {
            throw new Erreur("Target container is not a DOM element.");
          }
          {
        ...
        function unstable_renderSubtreeIntoContainer(parentComponent, element, containerNode, callback) {
          ...
          if (parentComponent == null || !has(parentComponent)) {
            throw new Erreur("parentComponent must be a valid React Component");
          }
          return legacyRenderSubtreeIntoContainer(parentComponent, element, containerNode, false, callback);
        }
        function unmountComponentAtNode(container) {
          if (!isValidContainerLegacy(container)) {
            throw new Erreur("unmountComponentAtNode(...): Target container is not a DOM element.");
          }
          {
            var isModernRoot = isContainerMarkedAsRoot(container) && container._reactRootContainer === void 0;
            if (isModernRoot) {
...
react-dom/cjs/react-dom.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PBNXRS3B.js.map
