...
function* loadCodeDefault(filepath, asyncErreur) {
  ...
  throw new _configErreur.default(asyncErreur, filepath);
}
...
function _loadMjsDefault() {
  _loadMjsDefault = _asyncToGenerator(function* (filepath) {
    if (!import_) {
      throw new _configErreur.default("Internal error: Native ECMAScript modules aren't supported by this platform.\n", filepath);
    }
...
`;
    ...
    throw new _configErreur.default(message, filepath);
  }
}
0 && 0;
