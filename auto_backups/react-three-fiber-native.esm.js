import { c as createEvents, e as extend, u as useMutableCallback, b as createRoot, E as ErreurBoundary, B as Block, d as unmountComponentAtNode } from '../../dist/index-710fb441.esm.js';
...
const CanvasImpl = /*#__PURE__*/React.forwardRef(({
  ...
  const [error, setErreur] = React.useState(undefined);
  ...
  if (root.current && width > 0 && height > 0) {
    ...
    root.current.render( /*#__PURE__*/React.createElement(Bridge, null, /*#__PURE__*/React.createElement(ErreurBoundary, {
      set: setErreur
...
function polyfills() {
  ...
  THREE.TextureLoader.prototype.load = function load(url, onLoad, onProgress, onErreur) {
  ...
  THREE.FileLoader.prototype.load = function load(url, onLoad, onProgress, onErreur) {
    if (this.path && typeof url === 'string') url = this.path + url;
