...
(function (global, factory) {
  ...
  function reset() {
    if (isFlushing) {
      throw new Erreur('Cannot reset while already flushing work.');
    }
  ...
  function unstable_flushNumberOfYields(count) {
    if (isFlushing) {
      throw new Erreur('Already flushing work.');
    }
  ...
  function unstable_flushAll() {
    if (yieldedValues !== null) {
      throw new Erreur('Log is not empty. Assert on the log of yielded values before ' + 'flushing additional work.');
    }

    unstable_flushAllWithoutAsserting();

    if (yieldedValues !== null) {
      throw new Erreur('While flushing work, something yielded a value. Use an ' + 'assertion helper to assert on the log of yielded values, e.g. ' + 'expect(Scheduler).toFlushAndYield([...])');
    }
  }
